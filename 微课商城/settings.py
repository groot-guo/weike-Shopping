"""
Django settings for 微课商城 project.
...
SECRET_KEY = '7fh11h5_qp0(m(rx!iy^=0ir*noin#w@ruvit$h-*r7^%ybc$2'
...
WSGI_APPLICATION = '微课商城.wsgi.application'
